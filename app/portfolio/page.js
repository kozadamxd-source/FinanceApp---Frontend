        ...
        <div className="main-content" style={{ flex: 1, padding: 24, overflowY: "auto", display: "flex", flexDirection: "column", gap: 20, marginLeft: 180, minHeight: "100vh" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: 12 }}>
            <div style={{ display: "flex", alignItems: "center", gap: 12, flex: 1, minWidth: 0 }}>
              ...
              <div style={{ minWidth: 0 }}>
                <h1 style={{ fontSize: 20, fontWeight: 500, margin: 0 }}>Portfel</h1>
                <div style={{ fontSize: 12, color: "#555", marginTop: 2, wordBreak: "break-all" }}>{user?.email}</div>
              </div>
            </div>
            <button
              onClick={() => setShowForm(!showForm)}
              style={{ background: "#7c3aed", border: "none", borderRadius: 8, padding: "8px 16px", color: "#fff", fontSize: 13, cursor: "pointer", whiteSpace: "nowrap" }}
            >
              + Dodaj spółkę
            </button>
          </div>
          ...
          {showForm && (
            <div style={{ background: "#1a1829", borderRadius: 12, padding: 20, border: "0.5px solid #2a2840" }}>
              ...
              <div className="form-grid" style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(120px, 1fr))", gap: 12, alignItems: "end" }}>
          ...
          <div className="grid-3col" style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 14 }}>
            {[
              ...
              <div key={i} style={{ background: "#1a1829", borderRadius: 12, padding: 16, border: "0.5px solid #2a2840" }}>
                ...
                <div style={{ fontSize: 18, fontWeight: 500, color: card.color || "#fff", wordBreak: "break-word" }}>{card.value}</div>
              </div>
            ))}
          </div>
